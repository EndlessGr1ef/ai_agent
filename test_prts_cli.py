...
def test_imports():
    ...
    try:
        from chroma_query_tool import ChromaQueryTool
...
def test_cli_structure():
    ...
    try:
        with open('prts_db_cli.py', 'r') as f:
            code = f.read()
        
        # Basic syntax check
        compile(code, 'prts_db_cli.py', 'exec')
